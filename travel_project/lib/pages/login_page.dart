...
import 'package:travel_project/pages/user_register_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  FirebaseAuth objetoAuth = FirebaseAuth
      .instance; //variable instancia el objeto de autenticacion//instance -crea el objeto
  ...
  void validarUsuario() async {
    //await - async se ejecuta en el transcurso del tiempo
    try {
      //toma los datos realiza la validacion y arroja el usuario si existe
      final user = await objetoAuth.signInWithEmailAndPassword(
            ...
            color: Colors.blueGrey
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                      labelText: "Password",
                      fillColor: Color(
                          0xFFE0F2F1), //color de fondo del texto  Colors.white,
                      filled: false, //false = condicion de aplicacion
                      //border: OutlineInputBorder(),
                      suffixIcon: Icon(
                        ...
                        size: 20,
                        color: Colors.black26,
                      ) //person_outline - remove_red_eye(abierto)
                      ),
                ),
